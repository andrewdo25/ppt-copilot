...
// @Title GenOutline
// @Description Generate an outline based on a topic and sponsor
// @Param   body    body    gpt.GenOutlineRequest     true    "Request containing topic and sponsor"
// @Success 200 {object} controllers.Response "Generated outline"
// @Failure 400 {object} controllers.Response "Invalid parameter"
// @Failure 500 {object} controllers.Response "Internal server error"
// @Router /gpt/gen_outline [post]
func (this *Controller) GenOutline() {
	...
	fmt.Println("Topic: ", request.Topic)
	fmt.Println("Sponsor: ", request.Sponsor)
