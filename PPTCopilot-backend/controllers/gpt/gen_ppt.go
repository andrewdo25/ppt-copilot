...
// @Title GenPPT
// @Description Generate a PowerPoint presentation based on an outline
// @Param   body    body    gpt.GenPPTRequest         true    "Request containing outline ID, template ID, project ID, and file name"
// @Success 200 {object} controllers.Response "Generated PowerPoint"
// @Failure 400 {object} controllers.Response "Invalid parameter"
// @Failure 500 {object} controllers.Response "Internal server error"
// @Router /gpt/gen_ppt [post]
